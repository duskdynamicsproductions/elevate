...
function WorkoutPlanningAnimation() {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      tl.to({}, { duration: 1.5 }); // View the screen
      ...
      tl.to({}, { duration: 1.5 }); // View updated state
        ...
        <div className="absolute inset-0 z-10" style={{ width: '125%', height: '125%', transform: 'scale(0.8)', transformOrigin: 'top left' }}>
          ...
          <div className="wo-screen-b absolute inset-0 bg-[#0a0a0c] z-30 flex flex-col overflow-hidden">
            ...
            <div className="px-5 overflow-y-auto no-scrollbar pb-16 flex-1">
              ...
              {/* GIF Card with Active Yellow Border */}
...
if (content.match(regex)) {
  ...
  console.log('Successfully implemented Screen B (Active Workout) with dynamic Done click effect and set queue shift.');
} else {
