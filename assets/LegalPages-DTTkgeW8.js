import{j as e,r as l,g as o,S as d}from"./index-B71c2ryS.js";import{F as u}from"./FloatingNav-4Kj-61Yk.js";import"./AnimatedLogo-CsnZEix0.js";import"./createLucideIcon-D3QC-4eJ.js";o.registerPlugin(d);function i({title:t,content:s}){l.useEffect(()=>{window.scrollTo(0,0);const a=o.context(()=>{o.to(".footer-wipe-item",{clipPath:"inset(0% 100% 0% 0%)",ease:"none",scrollTrigger:{trigger:document.body,start:"top top",end:"+=400",scrub:.5}})});return()=>a.revert()},[]);const c=()=>s.split(`
`).map((a,n)=>{const r=a.match(/^(\d+\.\s+)(.*)$/);return r?e.jsx("span",{className:"block mt-10 mb-2 text-lg md:text-xl font-bold text-white",children:r[2]},n):e.jsxs("span",{children:[a,`
`]},n)});return e.jsxs("div",{className:"relative min-h-screen bg-elevate-black font-display text-elevate-paper md:overflow-x-hidden pb-40 selection:bg-elevate-orange selection:text-white",children:[e.jsx(u,{centerText:t}),e.jsxs("div",{className:"relative z-10 mx-auto max-w-none px-6 pt-32 pb-20 md:px-12 lg:px-20",children:[e.jsx("h1",{className:"text-3xl md:text-5xl font-black text-white mb-10 tracking-tight",children:t}),e.jsx("div",{className:"whitespace-pre-wrap break-words text-xs md:text-sm leading-relaxed opacity-80 font-medium",children:c()})]}),e.jsx("div",{className:"hero-footer-anim fixed left-0 right-0 bottom-0 z-50 pointer-events-none",children:e.jsxs("div",{className:"relative w-full h-24 md:h-28 pointer-events-auto",children:[e.jsx("div",{className:"footer-wipe-item absolute left-6 right-6 top-8 md:left-12 md:right-12 lg:left-20 lg:right-20 md:top-8 h-[1px] bg-white"}),e.jsxs("div",{className:"absolute left-6 right-6 bottom-0 h-16 md:left-12 md:right-12 lg:left-20 lg:right-20 md:h-20 flex items-center justify-end gap-12 md:gap-24 text-white font-mono text-[10px] md:text-xs tracking-widest uppercase no-cursor-zone z-10",children:[e.jsx("a",{href:"https://www.instagram.com/not_brihit/?hl=en",target:"_blank",rel:"noreferrer",className:"footer-wipe-item opacity-80 hover:opacity-70 transition-opacity block py-4",children:"Follow Me"}),e.jsx("a",{href:"https://www.instagram.com/not_brihit/?hl=en",target:"_blank",rel:"noreferrer",className:"footer-wipe-item hover:opacity-70 transition-opacity block py-4",children:"Instagram +"}),e.jsx("a",{href:"https://www.linkedin.com/in/brihit-nath-7114623a6/",target:"_blank",rel:"noreferrer",className:"footer-wipe-item hover:opacity-70 transition-opacity block py-4",children:"LinkedIn +"})]})]})})]})}function g(){return e.jsx(i,{title:"Privacy Policy",content:`Version: 2026-08-14 Last updated: August 14, 2026
