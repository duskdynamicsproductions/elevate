...
function ReelsScrolledAnimation() {
  ...
  return (
    <div className="absolute top-[100px] left-0 right-0 bottom-[270px] pointer-events-none flex items-center justify-center" style={{ zIndex: 15 }}>
    ...
    <div className="relative font-display bg-elevate-black max-w-full">
      ...
      >
        ...
        <div className="relative z-10 flex flex-1 flex-col items-start justify-end px-6 pb-16 md:px-12 lg:px-20 lg:pb-28">
          ...
          <p className="hero-sub mt-6 md:mt-10 text-sm md:text-base font-['Space_Mono',monospace] font-bold uppercase tracking-widest text-elevate-orange overflow-hidden">
          ...
          <Reveal direction="up" delay={200} className="flex-shrink-0 md:-translate-y-16 order-1 md:order-2">
            <div className="relative w-[200px] md:w-[310px] lg:w-[360px]">
              ...
              <div className="relative rounded-[40px] border-[8px] border-elevate-paper/10 bg-[#111] shadow-[0_35px_60px_-15px_rgba(0,0,0,0.9)] overflow-hidden" style={{ aspectRatio: '9/19.5' }}>
                ...
                <div className="absolute bottom-0 left-0 right-0 px-2 md:px-4 pb-3 md:pb-5 pt-10 z-20"
                  style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.85) 60%, transparent)' }}>
                  <button className="w-full flex items-center justify-center gap-1.5 md:gap-2 rounded-full border border-white bg-black px-2 md:px-4 py-1.5 md:py-2.5 text-[9px] md:text-[11px] font-semibold text-white tracking-wide whitespace-nowrap">
                    {/* Google Icon */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-3 h-3 md:w-4 md:h-4 shrink-0">
