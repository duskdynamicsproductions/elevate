...
const regex = /function PhysicalAnalyticsAnimation\(\) \{[\s\S]*?(?=function HorizontalFeatures\(\) \{)/;
...
function PhysicalAnalyticsAnimation() {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex items-center justify-end pr-[10%] lg:pr-[15%]" style={{ zIndex: 15 }}>
      ...
      <div 
        ref={containerRef}
        className="relative mt-20 w-[280px] h-[580px] rounded-[3rem] border-[10px] border-[#0d0d12] bg-[#050505] shadow-[0_30px_80px_rgba(0,0,0,0.8)] overflow-hidden"
      >
          ...
          <div className="absolute inset-0 pt-10 flex flex-col bg-[#050505] overflow-hidden text-white">
            <div className="px-5 overflow-y-auto no-scrollbar pb-24 flex-1">
              ...
              <div className="relative w-full h-[380px] bg-[#0a0a0c] rounded-[2rem] border border-white/5 overflow-hidden mb-6 mt-4 flex flex-col justify-end p-5">
                 ...
                 <div className="absolute inset-0 w-full h-full opacity-80 bg-cover bg-top" style={{ backgroundImage: 'url("/Muscular System.png")' }}>
                 ...
                 <div className="absolute top-5 right-5 w-10 h-14 bg-gradient-to-b from-[#f59e0b] to-[#b45309] rounded-t-full rounded-b-md flex items-center justify-center shadow-[0_0_15px_rgba(217,119,6,0.5)] border border-[#fcd34d]/50">
                   <span className="text-white font-black text-lg drop-shadow-md">I</span>
                   <div className="absolute -bottom-2.5 left-0 w-2.5 h-4 bg-red-700 -skew-y-[30deg]"></div>
                   <div className="absolute -bottom-2.5 right-0 w-2.5 h-4 bg-red-700 skew-y-[30deg]"></div>
                 </div>
                 ...
                 <div className="bg-[#0a0a0c] rounded-3xl p-5 border border-white/5 mb-4 shadow-xl">
                    ...
                    <div className="flex gap-4">
                       <div className="w-1/2 flex items-center justify-center opacity-30">
                          <svg width="80" height="160" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1"><path d="M12 2a3 3 0 0 0-3 3v2a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3z"/><path d="M9 7H6a2 2 0 0 0-2 2v5h2v8h2v-8h4v8h2v-8h2V9a2 2 0 0 0-2-2h-3"/></svg>
                       </div>
                ...
                <div className="flex h-full pb-8">
                   ...
                   <div className="flex flex-col justify-between items-end pr-3 w-16 h-full pb-6 pt-6">
                      {['Back', 'Upper Arms', 'Thighs', 'Calves', 'Chest', 'Hips', 'Shoulders', 'Waist / Abs', 'Forearms', 'Hands', 'Neck', 'Feet'].map(muscle => (
                         <span className="text-white/60 text-[9px] transform -rotate-90 whitespace-nowrap" key={muscle}>{muscle}</span>
                      ))}
                   </div>
...
if (content.match(regex)) {
  ...
  console.log('Successfully scaled down font sizes in PhysicalAnalyticsAnimation and removed font-sans.');
} else {
  console.log('Could not find PhysicalAnalyticsAnimation to replace.');
}
